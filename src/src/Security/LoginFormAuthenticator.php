...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    /**
     * 1. Vérifier si on essaie de se connecter
     */
    ...
    /**
     * 2. Récuprer les données de formulaire
     */
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->userRepository->findOneBy(['email' => $credentials['username']])
            ?? $this->userRepository->findOneBy(['pseudo' => $credentials['username']]);
    ...
    /**
     * 5. Que faire après avoir été connecté ?
     */
